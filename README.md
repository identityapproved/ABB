...
| Task | Description |
| ---- | ----------- |
| `prompts` | Capture answers for the managed user, editor preference, hardening toggle, and installation toggles for `tools` and wordlists; cache responses in `/var/lib/vps-setup/answers.env`. |
